...
def tmp_sync_with_oc():
    ...
    """
    import subprocess
    cmd = "owncloudcmd --trust --non-interactive ~/Notebooks https://<YOUR_USER>:<YOUR_PASSWORD>@oc.rz-berlin.mpg.de/owncloud/remote.php/webdav/Notebooks"
...
class DeICContentsManager(FileContentsManager):
    def __init__(self, *args, **kwargs):
        ...
        self.oc = owncloud.Client('https://oc.rz-berlin.mpg.de/owncloud')
    ...
    def _oc_base_model(self,path, file_info):
        ...
        model['mimetype'] = None
        model['writable'] = None
        #check_perm(file_info.attributes['https://oc.rz-berlin.mpg.de/owncloud'],"WCK")
